...
func Quotabycounterkeys_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/quotas/%s%s", cfg.BaseURL, quotaCounterKey, queryString)
		...
		var result models.QuotaCounterCollection
...
func CreateQuotabycounterkeys_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_quotas_quotaCounterKey",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Quotabycounterkeys_listHandler(cfg),
	}
}
